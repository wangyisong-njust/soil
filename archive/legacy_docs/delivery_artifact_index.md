...
| --- | --- | --- | --- | --- |
| data | Preferred modeling data selected by pipeline | data/processed/soil_heavy_metals_geology.csv | ok | 1.04 |
...
| config | Input validation report | docs/input_validation_report.md | ok | 0.00 |
...
| docs | Parameter replacement guide | docs/parameter_replacement_guide.md | ok | 0.00 |
| docs | Main report | docs/report.md | ok | 0.04 |
| docs | Project delivery navigation guide | docs/project_delivery_guide.md | ok | 0.00 |
| docs | Submission package verification report | docs/submission_package_verification_report.md | ok | 0.00 |
| docs | Reproducibility snapshot | docs/reproducibility_snapshot.md | ok | 0.00 |
| docs | Leakage and publication reproducibility audit report | docs/leakage_publication_audit_report.md | ok | 0.00 |
| docs | Markdown local reference check report | docs/markdown_reference_check_report.md | ok | 0.06 |
| docs | Publication-grade recommendation report | docs/publication_grade_recommendation_report.md | ok | 0.00 |
| docs | Candidate eligibility audit report | docs/candidate_eligibility_audit_report.md | ok | 0.01 |
| docs | Publication model cards | docs/publication_model_cards.md | ok | 0.00 |
| docs | Manuscript-ready summary tables report | docs/manuscript_tables_report.md | ok | 0.01 |
| docs | Manuscript methods and results text snippets | docs/manuscript_text_snippets.md | ok | 0.01 |
| docs | Manuscript summary figure report | docs/manuscript_summary_figure_report.md | ok | 0.00 |
| docs | Submission readiness audit report | docs/submission_readiness_audit_report.md | ok | 0.00 |
| docs | Current visual summary report | docs/current_visual_summary_report.md | ok | 0.00 |
| docs | Feature importance summary report | docs/feature_importance_summary_report.md | ok | 0.01 |
| docs | Distributional robust model report | docs/distributional_robust_model_report.md | ok | 0.00 |
| docs | Random five-fold cross-validation report | docs/random_fivefold_cv_report.md | ok | 0.00 |
| docs | Fixed spatial background residual model report | docs/spatial_baseline_residual_fixed_report.md | ok | 0.00 |
| docs | Validation strategy and M0-M6 ablation report | docs/validation_strategy_and_ablation_report.md | ok | 0.01 |
| docs | Spatial block cross-validation report | docs/spatial_block_cv_report.md | ok | 0.00 |
| docs | Distribution-guided spatial quantile report | docs/distribution_guided_spatial_quantile_report.md | ok | 0.00 |
| docs | Yearwise spatial quantile validation report | docs/spatial_quantile_yearwise_validated_report.md | ok | 0.00 |
| docs | Yearwise validation-selected publication report | docs/yearwise_validation_selected_publication_report.md | ok | 0.00 |
| docs | Yearwise error and distribution shift diagnostics report | docs/yearwise_error_diagnostics_report.md | ok | 0.00 |
| docs | Publication-aligned future prediction report | docs/publication_aligned_future_prediction_report.md | ok | 0.00 |
...
| metrics | Publication model cards table | tables/publication_model_cards.csv | ok | 0.00 |
...
| metrics | Markdown local reference check details | tables/markdown_reference_check.csv | ok | 0.06 |
...
| predictions | Publication plotting predictions | results/recommended_prediction_grid_values.csv | ok | 0.06 |
| predictions | Future baseline predictions | results/future_predictions_baseline_2027_2035.csv | ok | 5.61 |
| predictions | Publication-aligned future predictions | results/future_predictions_publication_aligned_2027_2035.csv | ok | 11.20 |
| predictions | Publication-aligned future prediction intervals | results/future_predictions_publication_aligned_2027_2035_intervals.csv | ok | 24.82 |
| predictions | Future prediction intervals | results/future_predictions_baseline_2027_2035_intervals.csv | ok | 24.82 |
| predictions | Future exceedance probabilities | results/future_exceedance_probability_2027_2035.csv | ok | 58.37 |
| predictions | Distributional robust predictions | results/distributional_robust_predictions.csv | ok | 0.09 |
| predictions | Random five-fold cross-validation predictions | results/random_fivefold_cv_predictions.csv | ok | 2.55 |
| predictions | Fixed spatial background residual predictions | results/spatial_baseline_residual_fixed_predictions.csv | ok | 0.52 |
| predictions | Spatial block cross-validation predictions | results/spatial_block_cv_predictions.csv | ok | 2.91 |
| predictions | Distribution-guided spatial quantile predictions | results/distribution_guided_spatial_quantile_predictions.csv | ok | 0.13 |
...
| figures | Publication-grade R2 summary | figures/summary/publication_grade_recommended_r2.png | ok | 0.09 |
| figures | Manuscript summary overview figure | figures/manuscript_summary/manuscript_results_overview.png | ok | 0.35 |
| figures | Manuscript summary overview PDF | figures/manuscript_summary/manuscript_results_overview.pdf | ok | 0.04 |
| figures | Validation sensitivity R2 summary | figures/summary/publication_validation_sensitivity_r2.png | ok | 0.09 |
| figures | Random five-fold R2 summary | figures/validation_strategy/random_fivefold_best_r2.png | ok | 0.09 |
| figures | Framework M0-M6 ablation mean R2 | figures/validation_strategy/framework_module_ablation_mean_r2.png | ok | 0.08 |
| figures | Framework M0-M6 ablation target heatmap | figures/validation_strategy/framework_module_ablation_target_r2_heatmap.png | ok | 0.16 |
...
| figures | Top5 SHAP factors by target | figures/feature_importance_summary/top5_shap_factors_by_target.png | ok | 0.21 |
...
| figures | Publication yearwise RMSE heatmap | figures/yearwise_error_diagnostics/publication_yearwise_rmse_heatmap.png | ok | 0.14 |
| models | Serialized model files | models/*.joblib | ok | 95.90 |
| future_maps | Future baseline maps | figures/*/*_future_2035_baseline_map.png | ok | 1.72 |
| target_figures | Target-level diagnostic figures | figures/[A-H]/*.png | ok | 19.15 |
